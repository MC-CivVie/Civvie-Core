...
public class NameLayerCommand implements CommandExecutor, TabCompleter {
    ...
    public void createRankChangeInventory(Player player, NameLayer nameLayer, QuickPlayerData who){
        EZGUI ezgui = new EZGUI(Bukkit.createInventory(null,9,"Select a new rank for "+who.getLastName()));
    ...
    public void createInviteGUI(Player sender, NameLayer nameLayer){
        ...
        callableInviteRank(ItemsUtil.createItem(Material.LEATHER_CHESTPLATE,NameLayerRankEnum.GUEST.name(),1),NameLayerRankEnum.GUEST,sender,ezgui,0);
        callableInviteRank(ItemsUtil.createItem(Material.IRON_CHESTPLATE,NameLayerRankEnum.MEMBER.name(),1),NameLayerRankEnum.MEMBER,sender,ezgui,2);
        callableInviteRank(ItemsUtil.createItem(Material.GOLDEN_CHESTPLATE,NameLayerRankEnum.MANAGER.name(),1),NameLayerRankEnum.MANAGER,sender,ezgui,4);
        callableInviteRank(ItemsUtil.createItem(Material.DIAMOND_CHESTPLATE,NameLayerRankEnum.ADMIN.name(),1),NameLayerRankEnum.ADMIN,sender,ezgui,6);
        callableInviteRank(ItemsUtil.createItem(Material.NETHERITE_CHESTPLATE,NameLayerRankEnum.OWNER.name(),1),NameLayerRankEnum.OWNER,sender,ezgui,8);
